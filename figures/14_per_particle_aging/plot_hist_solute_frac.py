...
hist2d = camp.histogram_2d(emit_diam[bc_containing], aging_solute_fraction[bc_containing], 
			     x_axis, y_axis, weights = 1 / emit_comp_vols[bc_containing])

hist2d_morning = camp.histogram_2d(emit_diam[emit_morning], aging_solute_fraction[emit_morning], 
			     x_axis, y_axis, weights = 1 / emit_comp_vols[emit_morning])

hist2d_afternoon = camp.histogram_2d(emit_diam[emit_afternoon], aging_solute_fraction[emit_afternoon], 
