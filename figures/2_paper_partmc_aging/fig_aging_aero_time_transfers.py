...
cond_a_f_smooth = loadtxt("%s/aging_wc_num_cond_a_f_conc_smooth.txt" % aging_data_dir)
cond_f_a_smooth = loadtxt("%s/aging_wc_num_cond_f_a_conc_smooth.txt" % aging_data_dir)
coag_loss_a_f_smooth = loadtxt("%s/aging_wc_num_coag_loss_a_f_conc_smooth.txt" % aging_data_dir)
coag_loss_f_a_smooth = loadtxt("%s/aging_wc_num_coag_loss_f_a_conc_smooth.txt" % aging_data_dir)
