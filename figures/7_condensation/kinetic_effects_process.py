...
## calculate critical supersaturation for each particle
    ...
    env_state_080s = camp.env_state_t(ncf)
    ncf.close()

    ncf = scipy.io.netcdf.netcdf_file(filename_in_100, 'r')
    particles = camp.aero_particle_array_t(ncf)
    particles.sort_by_id()
    env_state_100s = camp.env_state_t(ncf)
    ncf.close()
    ...
    particles = camp.aero_particle_array_t(ncf)
    particles.sort_by_id()
    env_state_130s = camp.env_state_t(ncf)
    ncf.close()

    ncf = scipy.io.netcdf.netcdf_file(filename_in_150, 'r')
    particles = camp.aero_particle_array_t(ncf)
    particles.sort_by_id()
    env_state_150s = camp.env_state_t(ncf)
    ncf.close()
...
## calculate time series for RH and maximum RH that occurs
    ...
    env_state_history = camp.read_history(camp.env_state_t, dir_cloud, in_file_pattern)
...
## calculate time series for each particle
    print dir_cloud, in_file_pattern
    time_filename_list = camp.get_time_filename_list(dir_cloud, in_file_pattern)
...
## 1. particles that do not activate
    ...
    plot_index = camp.find_nearest_index(particles.ids, plot_id)
    ...
    wet_diameters_not_activate = camp.log_grid(min=1.1*dry_diam_not_activate, max=100*dry_diam_not_activate, n_bin=100).edges()

    equilib_rhs_not_activate_grid_080 = camp.equilib_rel_humids(env_state_080s,
            kappa_not_activate, dry_diam_not_activate, wet_diameters_not_activate)
    equilib_rhs_not_activate_grid_100 = camp.equilib_rel_humids(env_state_100s,
            kappa_not_activate, dry_diam_not_activate, wet_diameters_not_activate)
    equilib_rhs_not_activate_grid_130 = camp.equilib_rel_humids(env_state_130s,
            kappa_not_activate, dry_diam_not_activate, wet_diameters_not_activate)
    equilib_rhs_not_activate_grid_150 = camp.equilib_rel_humids(env_state_150s,
            kappa_not_activate, dry_diam_not_activate, wet_diameters_not_activate)
...
#    plot_index = camp.find_nearest_index(particles.ids, plot_id)
    ...
    wet_diameters_evaporation = camp.log_grid(min=1.1*dry_diam_evaporation, max=100*dry_diam_evaporation, n_bin=100).edges()

    equilib_rhs_evaporation_grid_080 = camp.equilib_rel_humids(env_state_080s,
            kappa_evaporation, dry_diam_evaporation, wet_diameters_evaporation)
    equilib_rhs_evaporation_grid_100 = camp.equilib_rel_humids(env_state_100s,
            kappa_evaporation, dry_diam_evaporation, wet_diameters_evaporation)
    equilib_rhs_evaporation_grid_130 = camp.equilib_rel_humids(env_state_130s,
            kappa_evaporation, dry_diam_evaporation, wet_diameters_evaporation)
    equilib_rhs_evaporation_grid_150 = camp.equilib_rel_humids(env_state_150s,
            kappa_evaporation, dry_diam_evaporation, wet_diameters_evaporation)
...
#    plot_index = camp.find_nearest_index(particles.ids, plot_id)
    ...
    wet_diameters_deactivation = camp.log_grid(min=1.1*dry_diam_deactivation, max=100*dry_diam_deactivation, n_bin=100).edges()

    equilib_rhs_deactivation_grid_080 = camp.equilib_rel_humids(env_state_080s,
            kappa_deactivation, dry_diam_deactivation, wet_diameters_deactivation)
    equilib_rhs_deactivation_grid_100 = camp.equilib_rel_humids(env_state_100s,
            kappa_deactivation, dry_diam_deactivation, wet_diameters_deactivation)
    equilib_rhs_deactivation_grid_130 = camp.equilib_rel_humids(env_state_130s,
            kappa_deactivation, dry_diam_deactivation, wet_diameters_deactivation)
    equilib_rhs_deactivation_grid_150 = camp.equilib_rel_humids(env_state_150s,
            kappa_deactivation, dry_diam_deactivation, wet_diameters_deactivation)
...
## 4. inertial type
    ...
    wet_diameters_inertial = camp.log_grid(min=1.1*dry_diam_inertial, max=100*dry_diam_inertial, n_bin=100).edges()

    equilib_rhs_inertial_grid_080 = camp.equilib_rel_humids(env_state_080s,
            kappa_inertial, dry_diam_inertial, wet_diameters_inertial)
    equilib_rhs_inertial_grid_100 = camp.equilib_rel_humids(env_state_100s,
            kappa_inertial, dry_diam_inertial, wet_diameters_inertial)
    equilib_rhs_inertial_grid_130 = camp.equilib_rel_humids(env_state_130s,
            kappa_inertial, dry_diam_inertial, wet_diameters_inertial)
    equilib_rhs_inertial_grid_150 = camp.equilib_rel_humids(env_state_150s,
            kappa_inertial, dry_diam_inertial, wet_diameters_inertial)
