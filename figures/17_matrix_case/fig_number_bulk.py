...
plt.clf()
plt.plot(array_wc[:,0], array_wc[:,7], 'b-', label = 'total camp')
plt.plot(array_wc[:,0], array_wc[:,8], 'k-', label = 'bc total camp')
plt.plot(array_wc[:,0], array_wc[:,9], 'r-', label = 'so4 total camp')
...
plt.clf()
plt.plot(array_wc[:,0], array_wc[:,10], 'k-', label = 'bc pure camp')
plt.plot(array_wc[:,0], array_wc[:,11], 'r-', label = 'so4 pure camp')
plt.plot(array_wc[:,0], array_wc[:,13], 'g-', label = 'bc mixed camp')
plt.plot(array_wc[:,0], array_wc[:,14], 'b-', label = 'so4 mixed camp')
