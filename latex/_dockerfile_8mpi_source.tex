...
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00041}00041 \# NOTE: Modify .dockerignore to whitelist files/directories to copy.}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00042}00042 COPY . /home/test\_user/camp/}
...
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00045}00045 RUN tar -\/zxvf /home/test\_user/camp/cvode-\/3.4-\/alpha.tar.gz \(\backslash\)}
...
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00064}00064 \# Build CAMP}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00065}00065  RUN mkdir build \(\backslash\)}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00066}00066     \&\& cd build \(\backslash\)}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00067}00067     \&\& export JSON\_FORTRAN\_HOME="{}/usr/local/jsonfortran-\/gnu-\/6.1.0"{} \(\backslash\)}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00068}00068     \&\& cmake -\/D CMAKE\_BUILD\_TYPE=release \(\backslash\)}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00069}00069              -\/D CMAKE\_C\_FLAGS\_DEBUG="{}-\/g -\/pg"{} \(\backslash\)}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00070}00070              -\/D CMAKE\_Fortran\_FLAGS\_DEBUG="{}-\/g -\/pg"{} \(\backslash\)}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00071}00071              -\/D CMAKE\_MODULE\_LINKER\_FLAGS="{}-\/pg"{} \(\backslash\)}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00072}00072              -\/D ENABLE\_DEBUG:BOOL=TRUE \(\backslash\)}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00073}00073              -\/D ENABLE\_MPI:BOOL=TRUE \(\backslash\)}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00074}00074              -\/D CMAKE\_Fortran\_COMPILER=/usr/lib64/openmpi/bin/mpif90 \(\backslash\)}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00075}00075              ../camp \(\backslash\)}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00076}00076     \&\& make \(\backslash\)}
\DoxyCodeLine{\Hypertarget{_dockerfile_8mpi_source_l00077}00077     \&\& sudo make install}
