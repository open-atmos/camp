...
\end{DoxyCode}
\hypertarget{camp_aero_rep_add_autotoc_md2}{}\doxysubsection{\texorpdfstring{Step 3. Add the aerosol representation to the {\ttfamily camp\+\_\+aero\+\_\+rep\+\_\+factory} module}{Step 3. Add the aerosol representation to the {\ttfamily camp\+\_\+aero\+\_\+rep\+\_\+factory} module}}\label{camp_aero_rep_add_autotoc_md2}
...
\DoxyCodeLine{\ \ \ \ \ ...}
\DoxyCodeLine{\ \ \ \ \ \textcolor{keywordflow}{case}\ ()}
...
\end{DoxyCode}
\hypertarget{camp_aero_rep_add_autotoc_md3}{}\doxysubsection{\texorpdfstring{Step 4. Add the new module to the CMake\+List file in the root directory.}{Step 4. Add the new module to the CMake\+List file in the root directory.}}\label{camp_aero_rep_add_autotoc_md3}
...
\end{DoxyCode}
\hypertarget{camp_aero_rep_add_autotoc_md4}{}\doxysubsection{\texorpdfstring{Step 5. Add unit tests for the new {\ttfamily aero\+\_\+rep\+\_\+foo\+\_\+t} and {\ttfamily aero\+\_\+rep\+\_\+foo\+\_\+state\+\_\+t} types}{Step 5. Add unit tests for the new {\ttfamily aero\+\_\+rep\+\_\+foo\+\_\+t} and {\ttfamily aero\+\_\+rep\+\_\+foo\+\_\+state\+\_\+t} types}}\label{camp_aero_rep_add_autotoc_md4}
