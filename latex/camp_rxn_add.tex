...
\end{DoxyCode}
\hypertarget{camp_rxn_add_autotoc_md12}{}\doxysubsection{\texorpdfstring{Step 2. Add the reaction to the {\ttfamily camp\+\_\+rxn\+\_\+factory} module}{Step 2. Add the reaction to the {\ttfamily camp\+\_\+rxn\+\_\+factory} module}}\label{camp_rxn_add_autotoc_md12}
...
\end{DoxyCode}
\hypertarget{camp_rxn_add_autotoc_md13}{}\doxysection{\texorpdfstring{Step 4. Add the new module to the CMake\+List file in the root directory.}{Step 4. Add the new module to the CMake\+List file in the root directory.}}\label{camp_rxn_add_autotoc_md13}
...
\end{DoxyCode}
\hypertarget{camp_rxn_add_autotoc_md14}{}\doxysubsection{\texorpdfstring{Step 5. Add unit tests for the new {\ttfamily rxn\+\_\+foo\+\_\+t} type}{Step 5. Add unit tests for the new {\ttfamily rxn\+\_\+foo\+\_\+t} type}}\label{camp_rxn_add_autotoc_md14}
