...
Adding a \mbox{\hyperlink{camp_rxn}{reaction}} to the \mbox{\hyperlink{index}{camp-\/chem}} module can be done in the following steps\+:\hypertarget{camp_rxn_add_autotoc_md10}{}\doxysubsection{Step 1. Create a new reaction module}\label{camp_rxn_add_autotoc_md10}
The module should be placed in the {\ttfamily /src/rxns} folder and extent the abstract {\ttfamily \mbox{\hyperlink{structcamp__rxn__data_1_1rxn__data__t}{camp\+\_\+rxn\+\_\+data\+::rxn\+\_\+data\+\_\+t}}} type, overriding all deferred functions, and providing a constructor that returns a pointer to a newly allocated instance of the new type\+:
...
\end{DoxyCode}
\hypertarget{camp_rxn_add_autotoc_md11}{}\doxysubsection{Step 2. Add the reaction to the \textbackslash{}c camp\+\_\+rxn\+\_\+factory module}\label{camp_rxn_add_autotoc_md11}
...
\end{DoxyCode}
\hypertarget{camp_rxn_add_autotoc_md12}{}\doxysection{Step 4. Add the new module to the CMake\+List file in the root directory.}\label{camp_rxn_add_autotoc_md12}
...
\end{DoxyCode}
\hypertarget{camp_rxn_add_autotoc_md13}{}\doxysubsection{Step 5. Add unit tests for the new \textbackslash{}c rxn\+\_\+foo\+\_\+t type}\label{camp_rxn_add_autotoc_md13}
Unit testing should cover, at minimum, the initialization, time derivative and Jacbian matrix functions, and in general 80\% code coverage is recommended. Some examples can be found in the {\ttfamily /src/test} folder.\hypertarget{camp_rxn_add_autotoc_md14}{}\doxysubsection{Step 6.  Update documentation}\label{camp_rxn_add_autotoc_md14}
TODO finish...\hypertarget{camp_rxn_add_autotoc_md15}{}\doxysubsection{Usage}\label{camp_rxn_add_autotoc_md15}
The new \mbox{\hyperlink{camp_rxn}{reaction type}} is now ready to use. To include a reaction of this type in a \mbox{\hyperlink{camp_mechanism}{mechanism}}, add a \mbox{\hyperlink{input_format_rxn}{reaction object}} to a new or existing \mbox{\hyperlink{input_format_camp_config}{camp-\/chem configuration file}} as part of a \mbox{\hyperlink{input_format_mechanism}{mechanism object}}. The reaction should have a {\bfseries{type}} corresponding to the newly created reaction type, along with any required parameters\+:
