...
Adding a \mbox{\hyperlink{camp_rxn}{reaction}} to the \mbox{\hyperlink{index}{camp-\/chem}} module can be done in the following steps\+:\hypertarget{camp_rxn_add_autotoc_md11}{}\doxysubsection{Step 1. Create a new reaction module}\label{camp_rxn_add_autotoc_md11}
...
\end{DoxyCode}
\hypertarget{camp_rxn_add_autotoc_md12}{}\doxysubsection{Step 2. Add the reaction to the \textbackslash{}c camp\+\_\+rxn\+\_\+factory module}\label{camp_rxn_add_autotoc_md12}
...
\end{DoxyCode}
\hypertarget{camp_rxn_add_autotoc_md13}{}\doxysection{Step 4. Add the new module to the CMake\+List file in the root directory.}\label{camp_rxn_add_autotoc_md13}
...
\end{DoxyCode}
\hypertarget{camp_rxn_add_autotoc_md14}{}\doxysubsection{Step 5. Add unit tests for the new \textbackslash{}c rxn\+\_\+foo\+\_\+t type}\label{camp_rxn_add_autotoc_md14}
Unit testing should cover, at minimum, the initialization, time derivative and Jacbian matrix functions, and in general 80\% code coverage is recommended. Some examples can be found in the {\ttfamily /src/test} folder.\hypertarget{camp_rxn_add_autotoc_md15}{}\doxysubsection{Step 6.  Update documentation}\label{camp_rxn_add_autotoc_md15}
TODO finish...\hypertarget{camp_rxn_add_autotoc_md16}{}\doxysubsection{Usage}\label{camp_rxn_add_autotoc_md16}
