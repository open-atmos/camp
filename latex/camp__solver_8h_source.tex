\hypertarget{camp__solver_8h_source}{}\doxysection{camp\+\_\+solver.\+h}
\label{camp__solver_8h_source}\index{camp\_solver.h@{camp\_solver.h}}
...
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00049}00049 \textcolor{keywordtype}{int} \mbox{\hyperlink{camp__solver_8h_a2fa3892570de5fd26fb97da6b91568ff}{guess\_helper}}(\textcolor{keyword}{const} realtype t\_n, \textcolor{keyword}{const} realtype h\_n, N\_Vector y\_n,}
...
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00071}00071 \textcolor{preprocessor}{\#ifdef CAMP\_USE\_GSL}}
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00072}00072 \textcolor{keywordtype}{double} gsl\_f(\textcolor{keywordtype}{double} x, \textcolor{keywordtype}{void} *param);}
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00073}00073 \textcolor{keyword}{typedef} \textcolor{keyword}{struct }\{}
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00074}00074   \textcolor{keywordtype}{int} ind\_var;              \textcolor{comment}{// independent variable index}}
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00075}00075   \textcolor{keywordtype}{int} dep\_var;              \textcolor{comment}{// dependent variable index}}
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00076}00076   realtype t;               \textcolor{comment}{// current model time (s)}}
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00077}00077   N\_Vector y;               \textcolor{comment}{// dependent variable array}}
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00078}00078   N\_Vector deriv;           \textcolor{comment}{// time derivative vector f(t,y)}}
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00079}00079   \mbox{\hyperlink{struct_solver_data}{SolverData}} *solver\_data;  \textcolor{comment}{// solver data}}
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00080}00080 \} GSLParam;}
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00081}00081 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00082}00082 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00083}00083 }
\DoxyCodeLine{\Hypertarget{camp__solver_8h_source_l00084}00084 \textcolor{preprocessor}{\#endif}}
