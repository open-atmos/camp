...
\item Eqs.~\ref{eq:R_m} to \ref{eq:R_ae} are used to calculate aerodynamic radius based on Naumann [2003]. This part is not included in current fractal code in CAMP.
\end{itemize}
