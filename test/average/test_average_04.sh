...
if ! ../../extract_aero_particles out/average_0001_00000001.nc || \
   ! sort out/average_0001_00000001_aero_particles.txt | grep -v '^[[:blank:]]*$' > out/average_aero_particles_sorted.txt || \
   ! ../../extract_aero_particles out/average_comp_0001_00000001.nc || \
   ! sort out/average_comp_0001_00000001_aero_particles.txt | grep -v '^[[:blank:]]*$' > out/average_comp_aero_particles_sorted.txt || \
