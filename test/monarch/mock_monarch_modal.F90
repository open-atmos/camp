...
program mock_monarch
  ...
  if(plot_case == 0)then
    ...
    name_aerosol_species_to_print(1)%string=("organic_matter_mode1.organic_matter.POA")
  elseif(plot_case == 1)then
  ...
  elseif(plot_case == 2)then
    ...
    name_aerosol_species_to_print(1)%string=("organic_matter_mode1.organic_matter.ISOP-P1_aero")
    name_aerosol_species_to_print(2)%string=("organic_matter_mode1.organic_matter.ISOP-P2_aero")
  elseif(plot_case ==3)then
    ...
    name_aerosol_species_to_print(1)%string=("organic_matter_mode1.organic_matter.TERP-P1_aero")
    name_aerosol_species_to_print(2)%string=("organic_matter_mode1.organic_matter.TERP-P2_aero")
  elseif(plot_case ==4)then
    name_gas_species_to_print(1)%string=("O3")
    name_gas_species_to_print(2)%string=("NO2")
    ...
    name_aerosol_species_to_print(1)%string=("organic_matter_mode1.organic_matter.POA")
    name_aerosol_species_to_print(2)%string=("organic_matter_mode2.organic_matter.POA")
    name_aerosol_species_to_print(3)%string=("organic_matter_mode3.organic_matter.POA")
    name_aerosol_species_to_print(4)%string=("organic_matter_mode1.organic_matter.ISOP-P1_aero")
    name_aerosol_species_to_print(5)%string=("organic_matter_mode2.organic_matter.ISOP-P1_aero")
    name_aerosol_species_to_print(6)%string=("organic_matter_mode3.organic_matter.ISOP-P1_aero")
    name_aerosol_species_to_print(7)%string=("organic_matter_mode1.organic_matter.ISOP-P2_aero")
    name_aerosol_species_to_print(8)%string=("organic_matter_mode2.organic_matter.ISOP-P2_aero")
    name_aerosol_species_to_print(9)%string=("organic_matter_mode3.organic_matter.ISOP-P2_aero")
  endif
