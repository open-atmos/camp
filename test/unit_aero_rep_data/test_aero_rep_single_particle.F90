  ...
  subroutine test_config_read()
    ...
    select type (aero_rep)
      type is (aero_rep_single_particle_t)
        ...
        call assert(438901931, aero_rep%aero_is_at_surface_(1) .eqv. .false.)
        call assert(545268641, aero_rep%aero_is_at_surface_(2) .eqv. .false.)
        call assert(450505920, aero_rep%aero_is_at_surface_(3) .eqv. .false.)
        call assert(160921440, aero_rep%aero_is_at_surface_(4) .eqv. .true.)
        call assert(013254644, aero_rep%aero_is_at_surface_(5) .eqv. .false.)
        call assert(691645657, aero_rep%aero_is_at_surface_(6) .eqv. .false.)
        call assert(916896739, aero_rep%aero_is_at_surface_(7) .eqv. .false.)
        call assert(668436322, aero_rep%aero_is_at_surface_(8) .eqv. .true.)
        call assert(952270724, aero_rep%aero_is_at_surface_(9) .eqv. .false.)
        call assert(410924438, aero_rep%aero_is_at_surface_(10) .eqv. .false.)
        call assert(266324037, aero_rep%aero_is_at_surface_(11) .eqv. .false.)
        call assert(008760891, aero_rep%aero_is_at_surface_(12) .eqv. .true.)
