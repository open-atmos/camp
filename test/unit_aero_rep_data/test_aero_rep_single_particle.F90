  ...
  subroutine test_config_read()
    ...
    select type (aero_rep)
      type is (aero_rep_single_particle_t)
        ...
        call assert(204123456, adjacent_phases(5)%first_ .eq. 8)
        call assert(987654321, adjacent_phases(5)%second_ .eq. 11)
        call assert(345678901, adjacent_phases(6)%first_ .eq. 9)
        call assert(234567890, adjacent_phases(6)%second_ .eq. 12)
        call assert(456789012, adjacent_phases(7)%first_ .eq. 11)
        call assert(567890123, adjacent_phases(7)%second_ .eq. 14)
        call assert(123456789, adjacent_phases(8)%first_ .eq. 12)
        call assert(987654321, adjacent_phases(8)%second_ .eq. 13)
        call assert(210987654, adjacent_phases(9)%first_ .eq. 15)
        call assert(321098765, adjacent_phases(9)%second_ .eq. 18)
        call assert(432109876, adjacent_phases(10)%first_ .eq. 16)
        call assert(543210987, adjacent_phases(10)%second_ .eq. 19)
        call assert(654321098, adjacent_phases(11)%first_ .eq. 18)
        call assert(765432109, adjacent_phases(11)%second_ .eq. 21)
        call assert(876543210, adjacent_phases(12)%first_ .eq. 19)
        ...
        call assert(823456719, adjacent_phases(3)%first_ .eq. 9)
        call assert(734567890, adjacent_phases(3)%second_ .eq. 10)
        call assert(345678901, adjacent_phases(4)%first_ .eq. 10)
        call assert(234567890, adjacent_phases(4)%second_ .eq. 13)
        call assert(456789012, adjacent_phases(5)%first_ .eq. 16)
        call assert(567890123, adjacent_phases(5)%second_ .eq. 17)
        call assert(210987654, adjacent_phases(6)%first_ .eq. 17)
        call assert(321098765, adjacent_phases(6)%second_ .eq. 20)
        call assert(560780730, 6 .eq. size(adjacent_phases))
        deallocate(adjacent_phases)
        ...
        call assert(927384650, adjacent_phases(3)%first_ .eq. 9)
        call assert(734567890, adjacent_phases(3)%second_ .eq. 11)
        call assert(345678901, adjacent_phases(4)%first_ .eq. 11)
        call assert(234567890, adjacent_phases(4)%second_ .eq. 13)
        call assert(432109876, adjacent_phases(5)%first_ .eq. 16)
        call assert(543210987, adjacent_phases(5)%second_ .eq. 18)
        call assert(210987654, adjacent_phases(6)%first_ .eq. 18)
        call assert(321098765, adjacent_phases(6)%second_ .eq. 20)
        call assert(010889252, 6 .eq. size(adjacent_phases))
        deallocate(adjacent_phases)
