...
!> \file
!> The camp_test_ternary_chemical_activation program
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  logical function run_ternary_chemical_activation_tests() result(passed)
    ...
    if (camp_solver_data%is_solver_available()) then
      passed = run_ternary_chemical_activation_test()
    else
      call warn_msg(609325241, "No solver available")
      passed = .true.
    end if
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !!   A -k1-> B -k2-> C
  !!
  !! where k1 and k2 are Ternary Chemical Activation reaction rate constants.
  logical function run_ternary_chemical_activation_test()
    ...
    if (camp_mpi_rank().eq.0) then
      ...
      input_file_path = 'test_ternary_chemical_activation_config.json'
      ...
      call assert(381329778, camp_core%get_chem_spec_data(chem_spec_data))
    ...
    if (camp_mpi_rank().eq.1) then
      ...
      if (run_ternary_chemical_activation_test) then
        results = 0
      else
        results = 1
      end if
    ...
    if (camp_mpi_rank().eq.0) then
      if (results.eq.0) then
        ...
        run_ternary_chemical_activation_test = .false.
      end if
    end if
  ...
  end function run_ternary_chemical_activation_test

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

end program camp_test_ternary_chemical_activation
