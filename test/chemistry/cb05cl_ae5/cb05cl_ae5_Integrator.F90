...
!
! File                 : cb05cl_ae5_Integrator.f90
...
MODULE cb05cl_ae5_Integrator

  USE cb05cl_ae5_Precision
  USE cb05cl_ae5_Global, ONLY: FIX, RCONST, TIME, ATOL, RTOL
  USE cb05cl_ae5_Parameters, ONLY: NVAR, NSPEC, NFIX, LU_NONZERO
  USE cb05cl_ae5_JacobianSP, ONLY: LU_DIAG
  USE cb05cl_ae5_LinearAlgebra, ONLY: KppDecomp, KppSolve, &
               Set2zero, WLAMCH
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      USE cb05cl_ae5_Parameters
      USE cb05cl_ae5_Global
      USE cb05cl_ae5_Function, ONLY: Fun
      USE cb05cl_ae5_Rates
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      USE cb05cl_ae5_Jacobian, ONLY: Jac_SP
      USE cb05cl_ae5_Rates
...
END MODULE cb05cl_ae5_Integrator
