...
C $Header: /project/work/rep/CCTM/src/chem/ebi_cb05cl_ae5/hrdata_mod.F,v 1.1.1.1 2008/02/08 21:09:23 sjr Exp $ 
...
c..EBI solver fixed parameters
      const int  NEBITER = 1000  ! No. of iterations for EBI
...
!OJORBA2
      INTEGER   N_EBI_SPC    ! No. of species of CB05
!OJORBA2
...
!OJORBA2
      INTEGER, ALLOCATABLE :: EBI_SPC( : ) ! Index of EBI species to nmm
!OJORBA2
