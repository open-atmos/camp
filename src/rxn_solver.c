  ...
  for (int i_rxn = 0; i_rxn < n_rxn; i_rxn++) {
    ...
    switch (rxn_type) {
      ...
      case RXN_RAOULT_PHASE_TRANSFER:
        rxn_raoult_phase_transfer_get_used_jac_elem(model_data, rxn_int_data,
                                                    rxn_float_data, jac);
        break;
      ...
      case RXN_VBS_NOX_DEPENDENT:
        rxn_vbs_nox_dependent_get_used_jac_elem(rxn_int_data, rxn_float_data, jac);
        break;
    }
  }
}
  ...
  for (int i_rxn = 0; i_rxn < n_rxn; i_rxn++) {
    ...
    switch (rxn_type) {
      ...
      case RXN_PHOTOLYSIS:
        ...
        break;
      case RXN_RAOULT_PHASE_TRANSFER:
        rxn_raoult_phase_transfer_update_ids(model_data, deriv_ids, jac,
                                             rxn_int_data, rxn_float_data);
        break;
      case RXN_SIMPOL_PHASE_TRANSFER:
      ...
      case RXN_WET_DEPOSITION:
        ...
        break;
      case RXN_VBS_NOX_DEPENDENT:
        rxn_vbs_nox_dependent_update_ids(model_data, deriv_ids, jac, rxn_int_data,
                                      rxn_float_data);
        break;
    }
  }
  ...
  for (int i_rxn = 0; i_rxn < n_rxn; i_rxn++) {
    ...
    switch (rxn_type) {
      ...
      case RXN_PHOTOLYSIS:
        ...
        break;
      case RXN_RAOULT_PHASE_TRANSFER:
        rxn_raoult_phase_transfer_update_env_state(
            model_data, rxn_int_data, rxn_float_data, rxn_env_data);
        break;
      case RXN_SIMPOL_PHASE_TRANSFER:
      ...
      case RXN_WET_DEPOSITION:
        ...
        break;
      case RXN_VBS_NOX_DEPENDENT:
        rxn_vbs_nox_dependent_update_env_state(model_data, rxn_int_data,
                                            rxn_float_data, rxn_env_data);
        break;
    }
  }
  ...
  for (int i_rxn = 0; i_rxn < n_rxn; i_rxn++) {
    ...
    switch (rxn_type) {
      ...
      case RXN_PHOTOLYSIS:
        ...
        break;
      case RXN_RAOULT_PHASE_TRANSFER:
        rxn_raoult_phase_transfer_calc_deriv_contrib(
            model_data, time_deriv, rxn_int_data, rxn_float_data, rxn_env_data,
            time_step);
        break;
      case RXN_SIMPOL_PHASE_TRANSFER:
      ...
      case RXN_WET_DEPOSITION:
        ...
        break;
      case RXN_VBS_NOX_DEPENDENT:
        rxn_vbs_nox_dependent_calc_deriv_contrib(model_data, time_deriv,
                                              rxn_int_data, rxn_float_data,
                                              rxn_env_data, time_step);
        break;
    }
  ...
  for (int i_rxn = 0; i_rxn < n_rxn; i_rxn++) {
    ...
    switch (rxn_type) {
      ...
      case RXN_PHOTOLYSIS:
        ...
        break;
      case RXN_RAOULT_PHASE_TRANSFER:
        rxn_raoult_phase_transfer_calc_jac_contrib(model_data, jac,
                                                   rxn_int_data, rxn_float_data,
                                                   rxn_env_data, time_step);
        break;
      case RXN_SIMPOL_PHASE_TRANSFER:
      ...
      case RXN_WET_DEPOSITION:
        ...
        break;
      case RXN_VBS_NOX_DEPENDENT:
        rxn_vbs_nox_dependent_calc_jac_contrib(model_data, jac, rxn_int_data,
                                            rxn_float_data, rxn_env_data,
                                            time_step);
        break;
    }
  ...
  for (int i_rxn = 0; i_rxn < n_rxn; i_rxn++) {
    ...
    switch (rxn_type) {
      ...
      case RXN_PHOTOLYSIS:
        ...
        break;
      case RXN_RAOULT_PHASE_TRANSFER:
        rxn_raoult_phase_transfer_print(rxn_int_data, rxn_float_data);
        break;
      case RXN_SIMPOL_PHASE_TRANSFER:
      ...
      case RXN_WET_DEPOSITION:
        ...
        break;
      case RXN_VBS_NOX_DEPENDENT:
        rxn_vbs_nox_dependent_print(rxn_int_data, rxn_float_data);
        break;
    }
  }
  fflush(stdout);
