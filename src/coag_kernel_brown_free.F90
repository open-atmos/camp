...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine kernel_brown_free(aero_particle_1, aero_particle_2, &
    ...
    call kernel_brown_free_helper(v1, d1, v2, d2, aero_data, &
         env_state%temp, k)

  end subroutine kernel_brown_free
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine kernel_brown_free_minmax(v1, v2, aero_data, env_state, &
       k_min, k_max)
  ...
  end subroutine kernel_brown_free_minmax
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !!
  !! Use Eq. 4 of Vemury and Pratsinis [1995].
  subroutine kernel_brown_free_helper(v1, d1, v2, d2, aero_data, &
       temp, bckernel)
  ...
  end subroutine kernel_brown_free_helper
