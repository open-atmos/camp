 ...
 *
 * Isomerisation reaction solver functions
 *
 */
/** \file
 * \brief Isomerisation reaction solver functions
 */
#include "../rxns.h"
#include <math.h>
#include <stdio.h>
...
#define A1_ float_data[3]
#define A2_ float_data[4]
#define A3_ float_data[5]
#define A4_ float_data[6]
 ...
 * \param jac Jacobian
 */
void rxn_isomerisation_get_used_jac_elem(int *rxn_int_data,
 ...
 * \param rxn_float_data Pointer to the reaction floating-point data
 */
void rxn_isomerisation_update_ids(ModelData *model_data, int *deriv_ids,
 ...
 */
void rxn_isomerisation_update_env_state(ModelData *model_data,
                                        int *rxn_int_data,
                                        double *rxn_float_data,
                                        double *rxn_env_data) {
  int *int_data = rxn_int_data;
  ...
  RATE_CONSTANT_ =
      A_ * exp(C_ / TEMPERATURE_K_) *
      (A0_ + (A1_ == 0.0 ? 0.0 : A1_ * TEMPERATURE_K_) +
       (A2_ == 0.0 ? 0.0 : A2_ * TEMPERATURE_K_ * TEMPERATURE_K_) +
       (A3_ == 0.0 ? 0.0
                   : A3_ * TEMPERATURE_K_ * TEMPERATURE_K_ * TEMPERATURE_K_) +
       (A4_ == 0.0 ? 0.0
                   : A4_ * TEMPERATURE_K_ * TEMPERATURE_K_ * TEMPERATURE_K_ *
                         TEMPERATURE_K_)) *
...
void rxn_isomerisation_calc_deriv_contrib(
 ...
 */
#ifdef CAMP_USE_SUNDIALS
void rxn_isomerisation_calc_jac_contrib(ModelData *model_data, Jacobian jac,
                                        int *rxn_int_data,
                                        double *rxn_float_data,
                                        double *rxn_env_data,
                                        double time_step) {
 ...
 * \param rxn_float_data Pointer to the reaction floating-point data
 */
void rxn_isomerisation_print(int *rxn_int_data, double *rxn_float_data) {
  int *int_data = rxn_int_data;
  double *float_data = rxn_float_data;
