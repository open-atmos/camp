...
module camp_constants
  ...
  !> smallest value available to a double precision real number
  real(kind=dp), parameter :: small_dp = -huge(0.d0)
  !> largest value available to a double precision real number
  real(kind=dp), parameter :: large_dp = huge(0.d0)
  ...
  type const_t
    ...
    real(kind=dp) :: earth_radius = 6.371E+3
    !> Planck constant x speed of light, J m
    real(kind=dp) :: hc = 6.626068E-34*2.99792458E8
  end type const_t
