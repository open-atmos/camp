...
module camp_camp_solver_data
  ...
  interface
    ...
    type(c_ptr) function solver_new(n_state_var, n_cells, var_type, &
                    ...
                    gpu_percentage, is_reset_jac) bind (c)
      use iso_c_binding
      ...
      integer(kind=c_int), value :: gpu_percentage
    ...
    subroutine sub_model_update_data(cell_id, sub_model_id, sub_model_type, &
      ...
      integer(kind=c_int), value :: cell_id
      !> Sub model solver id
      integer(kind=c_int) :: sub_model_id
      !> Reaction type to updateto update
      integer(kind=c_int), value :: sub_model_type
      !> Data required by reaction for updates
      type(c_ptr), value :: update_data
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine initialize(this, var_type, abs_tol, mechanisms, aero_phases, &
          ...
          spec_names, gpu_percentage, is_reset_jac)
    ...
    integer, intent(in) :: gpu_percentage, is_reset_jac
