...
void cudaGlobalSolveODE(ModelDataGPU md_object) {
  ...
  mdvo->ncf = dmdv->ncf;//todo delete (this should require check for failing cell to update, but since is generated in handlefailure maybe is not needed)
  mdvo->nef = dmdv->nef;
