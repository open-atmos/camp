...
void constructor_cvode_gpu2(CVodeMem cv_mem, SolverData *sd);
int CVode_gpu2(void *cvode_mem, realtype tout, N_Vector yout,
              realtype *tret, int itask, SolverData *sd);
int cudaCVode2(void *cvode_mem, realtype tout, N_Vector yout,
               realtype *tret, int itask, SolverData *sd);
void solver_get_statistics_gpu2(SolverData *sd);
void solver_reset_statistics_gpu2(SolverData *sd);
